...
/**
 * Wrapper provides access to a given an atom (of type A) to priority rules that
 * require it. The method can be injected into a priority to rule too allow that
 * rule to act on the any given atom class type.
 *
