 ...
 * rule too allow that rule to act on the any given atom class type. This special
 * case flips the hydrogen and pseudo atom priority h = 0 and R = 1 so that
 * implicit and explicit centres give the same label.
 *
