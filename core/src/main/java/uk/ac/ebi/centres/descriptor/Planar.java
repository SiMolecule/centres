 ...
 * pseudo-asymmetric centres are indicated in lower case.
 *
 * @author John May
 * @see Tetrahedral
 * @see Trigonal
...
public enum Planar
    ...
    /**
     * The two highest priority ligands are on the together (zusammen) on the
     * same side of a double bond. Also refereed to as 'cis' isomerism.
     */
    Z(Type.ASYMMETRIC),
    ...
    /**
     * The two highest priority ligands are on the together (zusammen) on the
     * same side of a double bond. This centres is pseudo-asymmetric and
     * indicates the priority is only defined by opposite tetrahedral centres.
     */
